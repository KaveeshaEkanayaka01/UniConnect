    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <h1 className="text-3xl font-black text-slate-900">Certificate Verification</h1>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-lg overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-2xl font-black text-slate-900">{credential.title || "-"}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg font-bold text-slate-900">{credential.issuer || "UniConnect"}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg font-bold text-slate-900">{credential.holderName || "-"}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg font-bold text-slate-900">{credential.holderStudentId || "-"}</p>
              </div>
          ...
          <div className="px-8 py-6 border-t border-slate-100 bg-slate-50">
            <p className="text-xs text-slate-500 text-center">
              This certificate has been cryptographically verified and is immutable. To report fraudulent credentials, contact UniConnect support.
            </p>
          </div>
        </div>
      </div>
